import VCF_parser_for_GS as vp

'''
Bundled with VCF_parser_for_GS.py. 
Output each SV's "svtype, position, svlen, allele_frequency, allele_count" from VCF. Use GenomeSTRiP SVGenotyper vcf output. 
Usage: python3 SV_statistics_for_GS.py -i Input.vcf -o Output.stats.txt
'''
